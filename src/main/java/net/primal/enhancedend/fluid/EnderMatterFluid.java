...
public abstract class EnderMatterFluid extends FlowableFluid {
    @Override
    ...
    public static class Flowing extends EnderMatterFluid {
        @Override
    ...
    public static class Still extends EnderMatterFluid {
        @Override
        public int getLevel(FluidState state) {
            return 8;
        }
