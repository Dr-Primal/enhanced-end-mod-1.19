...
import net.primal.enhancedend.block.custom.EEFluidMaterial;
...
public class EEFluids {
    ...
    public static void register() {
        ...
        ENDER_MATTER_BLOCK = Registry.register(Registry.BLOCK, new Identifier(EnhancedEnd.MOD_ID, "ender_matter_block"),
                new FluidBlock(EEFluids.STILL_ENDER_MATTER, FabricBlockSettings.of(EEFluidMaterial.ENDER_MATTER)){ });
        ENDER_MATTER_BUCKET = Registry.register(Registry.ITEM, new Identifier(EnhancedEnd.MOD_ID, "ender_matter_bucket"),
                new BucketItem(EEFluids.STILL_ENDER_MATTER, new FabricItemSettings().group(EEItemGroup.ENHANCED_END_ITEMS).recipeRemainder(Items.BUCKET).maxCount(1)));
    }
}
