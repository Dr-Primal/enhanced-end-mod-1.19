...
public class EndimintiumBowItem
        extends BowItem
        implements Vanishable {

    public EndimintiumBowItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        if ((double)(f = EndimintiumBowItem.getPullProgress(i = this.getMaxUseTime(stack) - remainingUseTicks)) < 0.1) {
            return;
        }
