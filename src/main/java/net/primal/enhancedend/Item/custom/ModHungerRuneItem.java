...
public class ModHungerRuneItem extends ModRuneItem{
    public ModHungerRuneItem(Settings settings) {
        super(settings);
    }
    @Override
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ...
            (user).addStatusEffect(new StatusEffectInstance(StatusEffects.SATURATION, 600, 0));
